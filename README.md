...
```
cscript ospp.vbs /sethst:kms.zhuxiaole.org
```
...
```
cscript "C:\Program Files (x86)\Microsoft Office\Office16\OSPP.VBS" /sethst:kms.zhuxiaole.org
```
